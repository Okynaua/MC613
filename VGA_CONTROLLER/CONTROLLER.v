module CONTROLLER (
    ...
    always @(posedge CLOCK_50 or negedge reset_n) begin
		if (!reset_n) begin
            ...
            // Detect SW changes and schedule a burst update across 8 cycles.
            ...
            if (init_write_pending) begin
                ...
                ppu_oam_write_en <= 1'b1;
                ppu_oam_sel <= 4'd2 + update_write_counter;
                ppu_oam_val <= {1'b0, sprite_base_val} + update_write_counter;

                case (update_write_counter)
                    3'd0: begin ppu_oam_sx <= 10'd256; ppu_oam_sy <= 9'd32; end
                    3'd1: begin ppu_oam_sx <= 10'd288; ppu_oam_sy <= 9'd32; end
                    3'd2: begin ppu_oam_sx <= 10'd320; ppu_oam_sy <= 9'd32; end
                    3'd3: begin ppu_oam_sx <= 10'd352; ppu_oam_sy <= 9'd32; end
                    3'd4: begin ppu_oam_sx <= 10'd256; ppu_oam_sy <= 9'd64; end
                    3'd5: begin ppu_oam_sx <= 10'd288; ppu_oam_sy <= 9'd64; end
                    3'd6: begin ppu_oam_sx <= 10'd320; ppu_oam_sy <= 9'd64; end
                    default: begin ppu_oam_sx <= 10'd352; ppu_oam_sy <= 9'd64; end
                endcase

                if (update_write_counter == 3'd7) begin
                    update_write_pending <= 1'b0;
                    update_write_counter <= 3'd0;
                end else begin
                    update_write_counter <= update_write_counter + 3'd1;
                end
